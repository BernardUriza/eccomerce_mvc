...
if(isset($_POST["divisa"])){
	...
	for($i = 0; $i < count($idProductos); $i ++){
		...
		$divisa = file_get_contents("https://free.currconv.com/api/v7/convert?q=USD_".$_POST["divisa"]."&compact=ultra&apiKey=a01ebaf9a1c69eb4ff79");
...
if(isset($_POST["metodoPago"]) && $_POST["metodoPago"] == "payu"){
	...
	for($i = 0; $i < count($idProductos); $i ++){
		...
		$divisa = file_get_contents("https://free.currconv.com/api/v7/convert?q=USD_".$_POST["divisaPayu"]."&compact=ultra&apiKey=a01ebaf9a1c69eb4ff79");
